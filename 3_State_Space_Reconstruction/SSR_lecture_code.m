%% This code accompanies the powerpoint slides on state space reconstruction.
% Script to simulate several nonlinear dynamical systems with
% chaotic dynamics and perform state space reconstruction of these
% simulated systems using average mutual information and false nearest
% neighbor. The main functions are (ChaosLibrary, AMI_, FNN, embed) are
% provided by Nonlinear Analysis Core, Center for Human Movement
% Variability, University of Nebraska at Omaha
% https://github.com/Nonlinear-Analysis-Core/NONANLibrary
